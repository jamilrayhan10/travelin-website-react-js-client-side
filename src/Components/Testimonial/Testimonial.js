          ...
          <div className="row">
            <div className="col-lg-4  my-5">
              <div className="testimonial text-center border p-3">
                ...
                <i class="fas fa-star text-warning"></i>
                <p className="pt-4">
                  Looking for other traveling words like wanderlust? Here we got
                  a comprehensive list with the best travel words for travel
                  lovers! Expand your mind and vocabulary wit these words
                  associated with vacation and adventure.
                </p>
                <h3>Hasan Mahmud</h3>
                <h5>Traveler</h5>
